...
DIGEST_RUSSIAN_QUALITY = (
    ...
    "Не вставляй символы с других письменностей (китайский, японский и т.п.); не плоди ломаные гибриды вроде «русское_english» внутри одного слова — "
    "латиница только в @никах, очевидных именах из переписки и привычных аббревиатурах (PoE2, GGG, API). "
    "Короткую цитату из чата на другом языке можно оставить в кавычках, без разрастания.\n"
